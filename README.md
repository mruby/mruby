...
The release candidate version 4.1.0 of mruby can be downloaded via the following URL: [https://github.com/mruby/mruby/archive/4.1.0-rc2.zip](https://github.com/mruby/mruby/archive/4.1.0-rc2.zip)
