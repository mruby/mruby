...
mrb_mruby_range_ext_gem_init(mrb_state* mrb)
{
  ...
  mrb_define_method_lit(mrb, s, "cover?", mrb_range_cover, MRB_ARGS_REQ(1));
  mrb_define_method_lit(mrb, s, "first",  mrb_range_first, MRB_ARGS_OPT(1));
  mrb_define_method_lit(mrb, s, "last",   mrb_range_last,  MRB_ARGS_OPT(1));
}
