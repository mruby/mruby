...
mrb_mruby_kernel_ext_gem_init(mrb_state *mrb)
{
  ...
  mrb_define_module_function_id(mrb, krn, MRB_SYM(fail), mrb_f_raise, MRB_ARGS_OPT(2));
  mrb_define_module_function_id(mrb, krn, MRB_SYM(caller), mrb_f_caller, MRB_ARGS_OPT(2));
  mrb_define_method_id(mrb, krn, MRB_SYM(__method__), mrb_f_method, MRB_ARGS_NONE());
  mrb_define_method_id(mrb, krn, MRB_SYM(__callee__), mrb_f_callee, MRB_ARGS_NONE());
  mrb_define_module_function_id(mrb, krn, MRB_SYM(Integer), mrb_f_integer, MRB_ARGS_ARG(1,1));
#ifndef MRB_NO_FLOAT
  mrb_define_module_function_id(mrb, krn, MRB_SYM(Float), mrb_f_float, MRB_ARGS_REQ(1));
#endif
  mrb_define_module_function_id(mrb, krn, MRB_SYM(String), mrb_f_string, MRB_ARGS_REQ(1));
  mrb_define_module_function_id(mrb, krn, MRB_SYM(Array), mrb_f_array, MRB_ARGS_REQ(1));
  mrb_define_module_function_id(mrb, krn, MRB_SYM(Hash), mrb_f_hash, MRB_ARGS_REQ(1));
}
