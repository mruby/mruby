...
static const mrb_mt_entry io_rom_entries[] = {
  MRB_MT_ENTRY(io_init,              MRB_SYM(initialize),       0),
  MRB_MT_ENTRY(io_init_copy,         MRB_SYM(initialize_copy),  MRB_MT_PRIVATE),
  MRB_MT_ENTRY(io_isatty,            MRB_SYM(isatty),           MRB_MT_NOARG),
  MRB_MT_ENTRY(io_eof,               MRB_SYM_Q(eof),            MRB_MT_NOARG),
  MRB_MT_ENTRY(io_getc,              MRB_SYM(getc),             MRB_MT_NOARG),
  MRB_MT_ENTRY(io_gets,              MRB_SYM(gets),             0),
  MRB_MT_ENTRY(io_read,              MRB_SYM(read),             0),
  MRB_MT_ENTRY(io_readchar,          MRB_SYM(readchar),         MRB_MT_NOARG),
  MRB_MT_ENTRY(io_readline,          MRB_SYM(readline),         0),
  MRB_MT_ENTRY(io_readlines,         MRB_SYM(readlines),        0),
  MRB_MT_ENTRY(io_sync,              MRB_SYM(sync),             MRB_MT_NOARG),
  MRB_MT_ENTRY(io_set_sync,          MRB_SYM_E(sync),           0),
  MRB_MT_ENTRY(io_sysread,           MRB_SYM(sysread),          0),
  MRB_MT_ENTRY(io_sysseek,           MRB_SYM(sysseek),          0),
  MRB_MT_ENTRY(io_syswrite,          MRB_SYM(syswrite),         0),
  MRB_MT_ENTRY(io_seek,              MRB_SYM(seek),             0),
  MRB_MT_ENTRY(io_close,             MRB_SYM(close),            MRB_MT_NOARG),
  MRB_MT_ENTRY(io_close_write,       MRB_SYM(close_write),      MRB_MT_NOARG),
  MRB_MT_ENTRY(io_set_close_on_exec, MRB_SYM_E(close_on_exec),  0),
  MRB_MT_ENTRY(io_close_on_exec_p,   MRB_SYM_Q(close_on_exec),  MRB_MT_NOARG),
  MRB_MT_ENTRY(io_closed,            MRB_SYM_Q(closed),         MRB_MT_NOARG),
  MRB_MT_ENTRY(io_flush,             MRB_SYM(flush),            MRB_MT_NOARG),
  MRB_MT_ENTRY(io_ungetc,            MRB_SYM(ungetc),           0),
  MRB_MT_ENTRY(io_ungetbyte,         MRB_SYM(ungetbyte),        0),
  MRB_MT_ENTRY(io_pos,               MRB_SYM(pos),              MRB_MT_NOARG),
  MRB_MT_ENTRY(io_pid,               MRB_SYM(pid),              MRB_MT_NOARG),
  MRB_MT_ENTRY(io_fileno,            MRB_SYM(fileno),           MRB_MT_NOARG),
  MRB_MT_ENTRY(io_write,             MRB_SYM(write),            0),
  MRB_MT_ENTRY(io_puts,              MRB_SYM(puts),             0),
  MRB_MT_ENTRY(io_print,             MRB_SYM(print),            0),
  MRB_MT_ENTRY(io_putc,              MRB_SYM(putc),             0),
  MRB_MT_ENTRY(io_lshift,            MRB_OPSYM(lshift),         0),
  MRB_MT_ENTRY(io_pread,             MRB_SYM(pread),            0),
  MRB_MT_ENTRY(io_pwrite,            MRB_SYM(pwrite),           0),
  MRB_MT_ENTRY(io_getbyte,           MRB_SYM(getbyte),          MRB_MT_NOARG),
  MRB_MT_ENTRY(io_readbyte,          MRB_SYM(readbyte),         MRB_MT_NOARG),
};
