...
mrb_mruby_array_ext_gem_init(mrb_state* mrb)
{
  ...
  mrb_define_method_lit(mrb, a, "assoc",  mrb_ary_assoc,  MRB_ARGS_REQ(1));
  mrb_define_method_lit(mrb, a, "at",     mrb_ary_at,     MRB_ARGS_REQ(1));
  mrb_define_method_lit(mrb, a, "rassoc", mrb_ary_rassoc, MRB_ARGS_REQ(1));
}
