...
static struct {
  union mrb_mt_ptr vals[SET_ROM_MT_SIZE];
  ...
  .keys = {
    ...
    MRB_MT_KEY(MRB_SYM(add),               MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_OPSYM(lshift),          MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(add),             MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(delete),            MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(delete),          MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__init),            MRB_MT_FUNC|MRB_MT_NOARG|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__merge),           MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__subtract),        MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__union),           MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__difference),      MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__intersection),    MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(__xor),             MRB_MT_FUNC|MRB_MT_PUBLIC),
    ...
    MRB_MT_KEY(MRB_SYM(reset),             MRB_MT_FUNC|MRB_MT_NOARG|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(add_all),           MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(delete_all),        MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(include_all),     MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(include_any),     MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(superset),        MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_OPSYM(ge),              MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(proper_superset), MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_OPSYM(gt),              MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(subset),          MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_OPSYM(le),              MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(proper_subset),   MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_OPSYM(lt),              MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(intersect),       MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_Q(disjoint),        MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_OPSYM(cmp),             MRB_MT_FUNC|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM(flatten),           MRB_MT_FUNC|MRB_MT_NOARG|MRB_MT_PUBLIC),
    MRB_MT_KEY(MRB_SYM_B(flatten),         MRB_MT_FUNC|MRB_MT_NOARG|MRB_MT_PUBLIC),
  }
};
static mrb_mt_tbl set_rom_mt = {
  SET_ROM_MT_SIZE, SET_ROM_MT_SIZE,
  (union mrb_mt_ptr*)&set_rom_data, NULL
};
