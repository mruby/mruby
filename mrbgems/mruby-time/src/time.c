...
static const mrb_mt_entry time_rom_entries[] = {
  ...
  MRB_MT_ENTRY_PRIVATE(time_init, MRB_SYM(initialize),     MRB_ARGS_REQ(1)),  /* 15.2.19.7.16 */
  MRB_MT_ENTRY_PRIVATE(time_init_copy, MRB_SYM(initialize_copy), MRB_ARGS_REQ(1)),  /* 15.2.19.7.17 */
