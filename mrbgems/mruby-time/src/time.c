...
static const mrb_mt_entry time_rom_entries[] = {
  MRB_MT_ENTRY(time_hash,      MRB_SYM(hash),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_eq,        MRB_SYM_Q(eql),           0),
  MRB_MT_ENTRY(time_eq,        MRB_OPSYM(eq),            0),
  MRB_MT_ENTRY(time_cmp,       MRB_OPSYM(cmp),           0),
  MRB_MT_ENTRY(time_plus,      MRB_OPSYM(add),           0),
  MRB_MT_ENTRY(time_minus,     MRB_OPSYM(sub),           0),
  MRB_MT_ENTRY(time_to_s,      MRB_SYM(to_s),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_to_s,      MRB_SYM(inspect),         MRB_MT_NOARG),
  MRB_MT_ENTRY(time_asctime,   MRB_SYM(asctime),         MRB_MT_NOARG),
  MRB_MT_ENTRY(time_asctime,   MRB_SYM(ctime),           MRB_MT_NOARG),
  MRB_MT_ENTRY(time_day,       MRB_SYM(day),             MRB_MT_NOARG),
  MRB_MT_ENTRY(time_dst_p,     MRB_SYM_Q(dst),           MRB_MT_NOARG),
  MRB_MT_ENTRY(time_getutc,    MRB_SYM(getgm),           MRB_MT_NOARG),
  MRB_MT_ENTRY(time_getlocal,  MRB_SYM(getlocal),        MRB_MT_NOARG),
  MRB_MT_ENTRY(time_getutc,    MRB_SYM(getutc),          MRB_MT_NOARG),
  MRB_MT_ENTRY(time_utc_p,     MRB_SYM_Q(gmt),           MRB_MT_NOARG),
  MRB_MT_ENTRY(time_utc,       MRB_SYM(gmtime),          MRB_MT_NOARG),
  MRB_MT_ENTRY(time_hour,      MRB_SYM(hour),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_localtime, MRB_SYM(localtime),       MRB_MT_NOARG),
  MRB_MT_ENTRY(time_day,       MRB_SYM(mday),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_min,       MRB_SYM(min),             MRB_MT_NOARG),
  MRB_MT_ENTRY(time_mon,       MRB_SYM(mon),             MRB_MT_NOARG),
  MRB_MT_ENTRY(time_mon,       MRB_SYM(month),           MRB_MT_NOARG),
  MRB_MT_ENTRY(time_sec,       MRB_SYM(sec),             MRB_MT_NOARG),
  MRB_MT_ENTRY(time_to_i,      MRB_SYM(to_i),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_usec,      MRB_SYM(usec),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_nsec,      MRB_SYM(nsec),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_nsec,      MRB_SYM(tv_nsec),         MRB_MT_NOARG),
  MRB_MT_ENTRY(time_utc,       MRB_SYM(utc),             MRB_MT_NOARG),
  MRB_MT_ENTRY(time_utc_p,     MRB_SYM_Q(utc),           MRB_MT_NOARG),
  MRB_MT_ENTRY(time_wday,      MRB_SYM(wday),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_yday,      MRB_SYM(yday),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_year,      MRB_SYM(year),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_zone,      MRB_SYM(zone),            MRB_MT_NOARG),
  MRB_MT_ENTRY(time_init,      MRB_SYM(initialize),      MRB_MT_PRIVATE),
  MRB_MT_ENTRY(time_init_copy, MRB_SYM(initialize_copy), MRB_MT_PRIVATE),
  MRB_MT_ENTRY(time_sunday,    MRB_SYM_Q(sunday),        MRB_MT_NOARG),
  MRB_MT_ENTRY(time_monday,    MRB_SYM_Q(monday),        MRB_MT_NOARG),
  MRB_MT_ENTRY(time_tuesday,   MRB_SYM_Q(tuesday),       MRB_MT_NOARG),
  MRB_MT_ENTRY(time_wednesday, MRB_SYM_Q(wednesday),     MRB_MT_NOARG),
  MRB_MT_ENTRY(time_thursday,  MRB_SYM_Q(thursday),      MRB_MT_NOARG),
  MRB_MT_ENTRY(time_friday,    MRB_SYM_Q(friday),        MRB_MT_NOARG),
  MRB_MT_ENTRY(time_saturday,  MRB_SYM_Q(saturday),      MRB_MT_NOARG),
