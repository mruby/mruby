...
mrb_mruby_fiber_gem_init(mrb_state* mrb)
{
  ...
  mrb_define_method_lit(mrb, c, "initialize", fiber_init,    MRB_ARGS_NONE());
  mrb_define_method_lit(mrb, c, "resume",     fiber_resume,  MRB_ARGS_ANY());
  mrb_define_method_lit(mrb, c, "transfer",   fiber_transfer, MRB_ARGS_ANY());
  mrb_define_method_lit(mrb, c, "alive?",     fiber_alive_p, MRB_ARGS_NONE());
  mrb_define_method_lit(mrb, c, "==",         fiber_eq,      MRB_ARGS_REQ(1));
