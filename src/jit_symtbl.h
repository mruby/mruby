...
void init_symtbl() {
  ...
  if(init == 0) {
    ...
    symtbl[50] = (void *) mrb_vm_iv_set;
    symtbl[51] = (void *) mrb_str_concat;
    symtbl[52] = (void *) ecall;
    symtbl[53] = (void *) mrb_ary_ref;
    ...
    symtbl[63] = (void *) mrb_fixnum_mul;
    symtbl[64] = (void *) stack_copy;
    ...
    symtbl[75] = (void *) _str_const_no_target_class;
    symtbl[76] = (void *) _str_const_op_debug_format;
  }
}
