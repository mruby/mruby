...
#define get_mrb_time(mrb, obj) ((struct mrb_time *) mrb_get_datatype((mrb), (obj), &mrb_time_type))
...
mrb_time_eq(mrb_state *mrb, mrb_value self)
{
  ...
  tm1 = get_mrb_time(mrb, self);
  tm2 = get_mrb_time(mrb, other);
