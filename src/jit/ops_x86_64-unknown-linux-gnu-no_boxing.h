...
0x48, 0x8b, 0x88, 0xa8, 0x00, 0x00, 0x00, /*641: mov    0xa8(%rax),%rcx */
...
0x48, 0x8b, 0x88, 0xa8, 0x00, 0x00, 0x00, /*6cb: mov    0xa8(%rax),%rcx */
...
0x48, 0x03, 0xb0, 0xc0, 0x00, 0x00, 0x00, /*6e3: add    0xc0(%rax),%rsi */
...
0x48, 0x8b, 0x88, 0xa8, 0x00, 0x00, 0x00, /*198: mov    0xa8(%rax),%rcx */
0x0f, 0xb7, 0x71, 0x04,                   /*19f: movzwl 0x4(%rcx),%esi */
0x48, 0x03, 0xb0, 0xc0, 0x00, 0x00, 0x00, /*1a3: add    0xc0(%rax),%rsi */
...
static size_t op_sizes_text[] = {
  ...
  sizeof(op_move__text), /* 32 */
  sizeof(op_loadl__text), /* 36 */
  sizeof(op_loadi__text), /* 28 */
  sizeof(op_loadsym__text), /* 34 */
  sizeof(op_loadnil__text), /* 28 */
  sizeof(op_loadself__text), /* 25 */
  sizeof(op_loadt__text), /* 28 */
  sizeof(op_loadf__text), /* 28 */
  sizeof(op_getglobal__text), /* 49 */
  sizeof(op_setglobal__text), /* 44 */
  sizeof(op_getspecial__text), /* 44 */
  sizeof(op_setspecial__text), /* 39 */
  sizeof(op_getiv__text), /* 49 */
  sizeof(op_setiv__text), /* 44 */
  sizeof(op_getcv__text), /* 89 */
  sizeof(op_setcv__text), /* 44 */
  sizeof(op_getconst__text), /* 96 */
  sizeof(op_setconst__text), /* 44 */
  sizeof(op_getmcnst__text), /* 113 */
  sizeof(op_setmcnst__text), /* 58 */
  sizeof(op_getupvar__text), /* 122 */
  sizeof(op_setupvar__text), /* 108 */
  sizeof(op_jmp__text), /* 0 */
  sizeof(op_jmpif__text), /* 11 */
  sizeof(op_jmpnot__text), /* 11 */
  sizeof(op_onerr__text), /* 145 */
  sizeof(op_rescue__text), /* 52 */
  ...
  sizeof(op_super__text), /* 704 */
  sizeof(op_argary__text), /* 724 */
  sizeof(op_enter__text), /* 1792 */
  sizeof(op_enter_method_m__text), /* 453 */
  sizeof(op_karg__text), /* 0 */
  sizeof(op_kdict__text), /* 0 */
  sizeof(op_return__text), /* 38 */
  sizeof(op_break__text), /* 24 */
  sizeof(op_tailcall__text), /* 793 */
  sizeof(op_blkpush__text), /* 211 */
  sizeof(op_add__text), /* 333 */
  sizeof(op_addi__text), /* 162 */
  sizeof(op_sub__text), /* 236 */
  sizeof(op_subi__text), /* 166 */
  sizeof(op_mul__text), /* 254 */
  sizeof(op_div__text), /* 204 */
  sizeof(op_eq__text), /* 262 */
  sizeof(op_lt__text), /* 217 */
  sizeof(op_le__text), /* 217 */
  sizeof(op_gt__text), /* 217 */
  sizeof(op_ge__text), /* 217 */
  sizeof(op_array__text), /* 64 */
  sizeof(op_arycat__text), /* 86 */
  sizeof(op_arypush__text), /* 48 */
  sizeof(op_aref__text), /* 90 */
  sizeof(op_aset__text), /* 53 */
  sizeof(op_apost__text), /* 447 */
  sizeof(op_string__text), /* 69 */
  sizeof(op_strcat__text), /* 48 */
  sizeof(op_hash__text), /* 193 */
  sizeof(op_lambda__text), /* 28 */
  sizeof(op_range__text), /* 85 */
  sizeof(op_oclass__text), /* 28 */
  sizeof(op_class__text), /* 144 */
  sizeof(op_module__text), /* 129 */
  sizeof(op_exec__text), /* 356 */
  sizeof(op_method__text), /* 65 */
  sizeof(op_sclass__text), /* 66 */
  sizeof(op_tclass__text), /* 127 */
  sizeof(op_debug__text), /* 35 */
  sizeof(op_stop__text), /* 13 */
  sizeof(op_err__text), /* 99 */
