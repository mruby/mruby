...
static uint8_t op_loadi[] = {
  ...
  0xc7, 0x80, 0x08, 0x10, 0xab, 0x00, 0x03, 0x00, 0x00, 0x00,/*8: movl   $0x3,0xab1008(%rax) */
...
static uint8_t op_loadnil[] = {
  ...
  0x48, 0x89, 0xfb,                         /*1: mov    %rdi,%rbx */
  0x48, 0x8b, 0x43, 0x18,                   /*4: mov    0x18(%rbx),%rax */
  0xc7, 0x80, 0x08, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*8: movl   $0x0,0xab1008(%rax) */
  0x48, 0x8b, 0x43, 0x18,                   /*12: mov    0x18(%rbx),%rax */
  0xc7, 0x80, 0x00, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*16: movl   $0x0,0xab1000(%rax) */
  0x48, 0x8b, 0x43, 0x18,                   /*20: mov    0x18(%rbx),%rax */
  0x8b, 0x90, 0x08, 0x10, 0xab, 0x00,       /*24: mov    0xab1008(%rax),%edx */
...
static uint8_t op_loadself[] = {
  ...
  0x48, 0x89, 0xfb,                         /*1: mov    %rdi,%rbx */
  0x48, 0x8b, 0x43, 0x18,                   /*4: mov    0x18(%rbx),%rax */
  0x8b, 0x70, 0x18,                         /*8: mov    0x18(%rax),%esi */
  0x48, 0x8b, 0xbb, 0x98, 0x02, 0x00, 0x00, /*b: mov    0x298(%rbx),%rdi */
...
static uint8_t op_setupvar[] = {
  ...
  0xff, 0x93, 0x70, 0x02, 0x00, 0x00,       /*d: callq  *0x270(%rbx) */
...
static uint8_t op_send[] = {
  ...
  0x48, 0x8b, 0x43, 0x10,                   /*5: mov    0x10(%rbx),%rax */
  0x8b, 0x28,                               /*9: mov    (%rax),%ebp */
  0x83, 0xe5, 0x7f,                         /*b: and    $0x7f,%ebp */
  0x48, 0x8b, 0xbb, 0xa8, 0x02, 0x00, 0x00, /*e: mov    0x2a8(%rbx),%rdi */
...
static uint8_t op_sendb[] = {
  0x53,                                     /*0: push   %rbx */
  0x48, 0x89, 0xfb,                         /*1: mov    %rdi,%rbx */
  0xff, 0x93, 0x48, 0x02, 0x00, 0x00,       /*4: callq  *0x248(%rbx) */
...
static uint8_t op_enter[] = {
  ...
  0xe9, 0xdc, 0x02, 0x00, 0x00,             /*170: jmpq   451 <op_enter+0x451> */
...
static uint8_t op_addi[] = {
  ...
  0x4c, 0x8d, 0xb5, 0x00, 0x10, 0xab, 0x00, /*f: lea    0xab1000(%rbp),%r14 */
  ...
  0x75, 0x17,                               /*65: jne    7e <op_addi+0x7e> */
  0xf2, 0x41, 0x0f, 0x10, 0x06,             /*67: movsd  (%r14),%xmm0 */
  0xf2, 0x0f, 0x58, 0x05, 0x00, 0x00, 0x00, 0x00,/*6c: addsd  0x0(%rip),%xmm0        # 74 <op_addi+0x74> */
  0xf2, 0x41, 0x0f, 0x11, 0x06,             /*74: movsd  %xmm0,(%r14) */
  0xe9, 0x88, 0x00, 0x00, 0x00,             /*79: jmpq   106 <op_addi+0x106> */
  0x83, 0xf8, 0x03,                         /*7e: cmp    $0x3,%eax */
  0x75, 0x3b,                               /*81: jne    be <op_addi+0xbe> */
  ...
  0xeb, 0x14,                               /*f0: jmp    106 <op_addi+0x106> */
...
static uint8_t op_eq[] = {
  ...
  0x41, 0xff, 0x96, 0x48, 0x02, 0x00, 0x00, /*ec: callq  *0x248(%r14) */
...
static uint8_t op_exec[] = {
  ...
  0x74, 0x47,                               /*9a: je     e3 <op_exec+0xe3> */
  0x41, 0xc7, 0x46, 0x18, 0x00, 0x00, 0x00, 0x00,/*9c: movl   $0x0,0x18(%r14) */
  ...
  0x48, 0x89, 0x45, 0x00,                   /*b9: mov    %rax,0x0(%rbp) */
  ...
  0xeb, 0x1e,                               /*136: jmp    156 <op_exec+0x156> */
...
static uint8_t op_stop[] = {
  0x53,                                     /*0: push   %rbx */
  0x48, 0x89, 0xfb,                         /*1: mov    %rdi,%rbx */
  0x48, 0x8b, 0xbb, 0x08, 0x03, 0x00, 0x00, /*4: mov    0x308(%rbx),%rdi */
  0x31, 0xc0,                               /*b: xor    %eax,%eax */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*d: callq  *0x170(%rbx) */
