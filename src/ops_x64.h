...
static uint8_t op_call[] = {
  ...
  0x49, 0x8b, 0x4e, 0x28,                   /*3b: mov    0x28(%r14),%rcx */
  0x48, 0x83, 0x79, 0x18, 0x00,             /*3f: cmpq   $0x0,0x18(%rcx) */
  0x75, 0x10,                               /*44: jne    56 <op_call+0x56> */
  0x48, 0x8b, 0x73, 0x58,                   /*46: mov    0x58(%rbx),%rsi */
  0x48, 0x8b, 0x76, 0x18,                   /*4a: mov    0x18(%rsi),%rsi */
  0x48, 0x8b, 0x76, 0x08,                   /*4e: mov    0x8(%rsi),%rsi */
  0x48, 0x89, 0x71, 0x18,                   /*52: mov    %rsi,0x18(%rcx) */
  0x41, 0xf6, 0x46, 0x02, 0x04,             /*56: testb  $0x4,0x2(%r14) */
  0x74, 0x36,                               /*5b: je     93 <op_call+0x93> */
  0x48, 0x8b, 0x7b, 0x58,                   /*5d: mov    0x58(%rbx),%rdi */
  0x4c, 0x89, 0xf6,                         /*61: mov    %r14,%rsi */
  0x41, 0xff, 0x56, 0x18,                   /*64: callq  *0x18(%r14) */
  0x49, 0x89, 0xc6,                         /*68: mov    %rax,%r14 */
  0x89, 0xd5,                               /*6b: mov    %edx,%ebp */
  0x48, 0x8b, 0x7b, 0x58,                   /*6d: mov    0x58(%rbx),%rdi */
  0x8b, 0x73, 0x50,                         /*71: mov    0x50(%rbx),%esi */
  0xff, 0x93, 0x10, 0x01, 0x00, 0x00,       /*74: callq  *0x110(%rbx) */
  0x48, 0x8b, 0x43, 0x58,                   /*7a: mov    0x58(%rbx),%rax */
  0x48, 0x83, 0x78, 0x28, 0x00,             /*7e: cmpq   $0x0,0x28(%rax) */
  0x74, 0x58,                               /*83: je     dd <op_call+0xdd> */
  0x48, 0x89, 0xdf,                         /*85: mov    %rbx,%rdi */
  0xff, 0x93, 0xa8, 0x01, 0x00, 0x00,       /*88: callq  *0x1a8(%rbx) */
  0xe9, 0x31, 0x01, 0x00, 0x00,             /*8e: jmpq   1c4 <op_call+0x1c4> */
  0x4c, 0x89, 0x33,                         /*93: mov    %r14,(%rbx) */
  0x49, 0x8b, 0x4e, 0x18,                   /*96: mov    0x18(%r14),%rcx */
  0x48, 0x89, 0x4b, 0x08,                   /*9a: mov    %rcx,0x8(%rbx) */
  0x48, 0x85, 0xc9,                         /*9e: test   %rcx,%rcx */
  0x0f, 0x84, 0x99, 0x00, 0x00, 0x00,       /*a1: je     140 <op_call+0x140> */
  0x48, 0x8b, 0x51, 0x10,                   /*a7: mov    0x10(%rcx),%rdx */
  0x48, 0x89, 0x53, 0x20,                   /*ab: mov    %rdx,0x20(%rbx) */
  0x48, 0x8b, 0x51, 0x18,                   /*af: mov    0x18(%rcx),%rdx */
  0x48, 0x89, 0x53, 0x28,                   /*b3: mov    %rdx,0x28(%rbx) */
  0x0f, 0xb7, 0x49, 0x02,                   /*b7: movzwl 0x2(%rcx),%ecx */
  0x89, 0x48, 0x18,                         /*bb: mov    %ecx,0x18(%rax) */
  0x8b, 0x50, 0x40,                         /*be: mov    0x40(%rax),%edx */
  0x48, 0x8b, 0x43, 0x08,                   /*c1: mov    0x8(%rbx),%rax */
  0x48, 0x8b, 0x7b, 0x58,                   /*c5: mov    0x58(%rbx),%rdi */
  0x0f, 0xb7, 0x70, 0x02,                   /*c9: movzwl 0x2(%rax),%esi */
  0x85, 0xd2,                               /*cd: test   %edx,%edx */
  0x0f, 0x88, 0x97, 0x00, 0x00, 0x00,       /*cf: js     16c <op_call+0x16c> */
  0x83, 0xc2, 0x02,                         /*d5: add    $0x2,%edx */
  0xe9, 0x9f, 0x00, 0x00, 0x00,             /*d8: jmpq   17c <op_call+0x17c> */
  0x48, 0x8b, 0x40, 0x18,                   /*dd: mov    0x18(%rax),%rax */
  0x48, 0x8b, 0x48, 0x20,                   /*e1: mov    0x20(%rax),%rcx */
  0x48, 0x8b, 0x51, 0x10,                   /*e5: mov    0x10(%rcx),%rdx */
  0x48, 0x89, 0x50, 0x08,                   /*e9: mov    %rdx,0x8(%rax) */
  0x48, 0x89, 0x53, 0x18,                   /*ed: mov    %rdx,0x18(%rbx) */
  0x48, 0x63, 0x41, 0x44,                   /*f1: movslq 0x44(%rcx),%rax */
  0x48, 0xc1, 0xe0, 0x04,                   /*f5: shl    $0x4,%rax */
  0x4c, 0x89, 0x34, 0x02,                   /*f9: mov    %r14,(%rdx,%rax,1) */
  0x89, 0x6c, 0x02, 0x08,                   /*fd: mov    %ebp,0x8(%rdx,%rax,1) */
  0x48, 0x8b, 0x41, 0x30,                   /*101: mov    0x30(%rcx),%rax */
  0x48, 0x89, 0x43, 0x10,                   /*105: mov    %rax,0x10(%rbx) */
  0x48, 0x8b, 0x7b, 0x58,                   /*109: mov    0x58(%rbx),%rdi */
  0xff, 0x93, 0x60, 0x01, 0x00, 0x00,       /*10d: callq  *0x160(%rbx) */
  0x48, 0x8b, 0x43, 0x58,                   /*113: mov    0x58(%rbx),%rax */
  0x48, 0x8b, 0x40, 0x18,                   /*117: mov    0x18(%rax),%rax */
  0x48, 0x8b, 0x40, 0x20,                   /*11b: mov    0x20(%rax),%rax */
  0x48, 0x8b, 0x40, 0x08,                   /*11f: mov    0x8(%rax),%rax */
  0x48, 0x8b, 0x40, 0x18,                   /*123: mov    0x18(%rax),%rax */
  0x48, 0x89, 0x43, 0x08,                   /*127: mov    %rax,0x8(%rbx) */
  0x48, 0x8b, 0x48, 0x10,                   /*12b: mov    0x10(%rax),%rcx */
  0x48, 0x89, 0x4b, 0x20,                   /*12f: mov    %rcx,0x20(%rbx) */
  0x48, 0x8b, 0x40, 0x18,                   /*133: mov    0x18(%rax),%rax */
  0x48, 0x89, 0x43, 0x28,                   /*137: mov    %rax,0x28(%rbx) */
  0xe9, 0x84, 0x00, 0x00, 0x00,             /*13b: jmpq   1c4 <op_call+0x1c4> */
  0x48, 0x8b, 0x43, 0x58,                   /*140: mov    0x58(%rbx),%rax */
  0x48, 0x8b, 0x40, 0x18,                   /*144: mov    0x18(%rax),%rax */
  0x48, 0x8b, 0x40, 0x08,                   /*148: mov    0x8(%rax),%rax */
  0x48, 0xc7, 0x00, 0x00, 0x00, 0x00, 0x00, /*14c: movq   $0x0,(%rax) */
  0xc7, 0x40, 0x08, 0x00, 0x00, 0x00, 0x00, /*153: movl   $0x0,0x8(%rax) */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*15a: mov    $0xab0000,%esi */
  0x31, 0xd2,                               /*15f: xor    %edx,%edx */
  0x48, 0x89, 0xdf,                         /*161: mov    %rbx,%rdi */
  0xff, 0x93, 0x90, 0x00, 0x00, 0x00,       /*164: callq  *0x90(%rbx) */
  0xeb, 0x58,                               /*16a: jmp    1c4 <op_call+0x1c4> */
  ...
  0xff, 0x93, 0x40, 0x01, 0x00, 0x00,       /*17c: callq  *0x140(%rbx) */
  0x48, 0x8b, 0x43, 0x58,                   /*182: mov    0x58(%rbx),%rax */
  0x48, 0x8b, 0x40, 0x18,                   /*186: mov    0x18(%rax),%rax */
  0x48, 0x8b, 0x40, 0x08,                   /*18a: mov    0x8(%rax),%rax */
  0x48, 0x89, 0x43, 0x18,                   /*18e: mov    %rax,0x18(%rbx) */
  0x49, 0x8b, 0x4e, 0x28,                   /*192: mov    0x28(%r14),%rcx */
  ...
  0x48, 0x8b, 0x43, 0x08,                   /*1a8: mov    0x8(%rbx),%rax */
  0x48, 0x8b, 0x40, 0x08,                   /*1ac: mov    0x8(%rax),%rax */
  0x48, 0x89, 0x43, 0x10,                   /*1b0: mov    %rax,0x10(%rbx) */
  0x48, 0x8b, 0x7b, 0x58,                   /*1b4: mov    0x58(%rbx),%rdi */
  0x4c, 0x89, 0xf6,                         /*1b8: mov    %r14,%rsi */
  0x48, 0x89, 0xda,                         /*1bb: mov    %rbx,%rdx */
  0xff, 0x93, 0x20, 0x01, 0x00, 0x00,       /*1be: callq  *0x120(%rbx) */
  0x48, 0x89, 0xdf,                         /*1c4: mov    %rbx,%rdi */
  0x5b,                                     /*1c7: pop    %rbx */
  0x41, 0x5e,                               /*1c8: pop    %r14 */
  0x5d,                                     /*1ca: pop    %rbp */

};

static void op_call_set_args(uint8_t *op, uint32_t a, int32_t b, uint8_t c, uint32_t op_idx) {
  *((int32_t *)(op + 347)) = a * 1 + 0;
}
...
static uint8_t op_enter[] = {
  ...
  0x4c, 0x8b, 0x80, 0x78, 0x02, 0x00, 0x00, /*b5: mov    0x278(%rax),%r8 */
  0x4c, 0x8b, 0x88, 0x80, 0x02, 0x00, 0x00, /*bc: mov    0x280(%rax),%r9 */
...
static uint8_t op_enter_method_m[] = {
  ...
  0x4d, 0x8b, 0x86, 0x78, 0x02, 0x00, 0x00, /*68: mov    0x278(%r14),%r8 */
  0x4d, 0x8b, 0x8e, 0x80, 0x02, 0x00, 0x00, /*6f: mov    0x280(%r14),%r9 */
  0xb9, 0x0d, 0x00, 0x00, 0x00,             /*76: mov    $0xd,%ecx */
  0x41, 0xff, 0x96, 0x30, 0x01, 0x00, 0x00, /*7b: callq  *0x130(%r14) */
  ...
  0x41, 0xff, 0x96, 0x58, 0x02, 0x00, 0x00, /*a7: callq  *0x258(%r14) */
...
static uint8_t op_lambda[] = {
  ...
  0xff, 0x93, 0x48, 0x01, 0x00, 0x00,       /*17: callq  *0x148(%rbx) */
