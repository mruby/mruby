...
static uint8_t op_move[] = {
  ...
  0x48, 0x8b, 0x88, 0x00, 0x10, 0xbc, 0x00, /*04: mov     +0xbc1000(%rax), %rcx    */
  0x48, 0x8b, 0x90, 0x08, 0x10, 0xbc, 0x00, /*0b: mov     +0xbc1008(%rax), %rdx    */
...
static uint8_t op_loadl[] = {
  ...
  0x48, 0x8b, 0x91, 0x00, 0x10, 0xbc, 0x00, /*08: mov     +0xbc1000(%rcx), %rdx    */
  0x48, 0x8b, 0x89, 0x08, 0x10, 0xbc, 0x00, /*0f: mov     +0xbc1008(%rcx), %rcx    */
...
/* args: {"a"=>[[16, 8, 10..13], [16, 0, 24..27], [16, 8, 38..41], [1, 0, 50..53]], "b"=>[[1, 0, 28..31]]} */
static uint8_t op_loadi[] = {
  ...
  0xc7, 0x80, 0x00, 0x10, 0xab, 0x00, 0x00, 0x00, 0xbc, 0x00,/*16: movl    $0xbc0000, +0xab1000(%rax) */
  0x48, 0x8b, 0x43, 0x18,                   /*20: mov     +0x18(%rbx), %rax        */
  0x8b, 0x90, 0x08, 0x10, 0xab, 0x00,       /*24: mov     +0xab1008(%rax), %edx    */
...
static uint8_t op_loadsym[] = {
  0x48, 0x8b, 0x47, 0x18,                   /*00: mov     +0x18(%rdi), %rax        */
  0xc7, 0x80, 0x08, 0x10, 0xab, 0x00, 0x04, 0x00, 0x00, 0x00,/*04: movl    $0x4, +0xab1008(%rax)    */
...
/* args: {"a"=>[[16, 8, 10..13], [16, 0, 24..27], [16, 8, 38..41], [1, 0, 50..53]]} */
static uint8_t op_loadnil[] = {
  ...
  0x48, 0x8b, 0x43, 0x18,                   /*12: mov     +0x18(%rbx), %rax        */
  0xc7, 0x80, 0x00, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*16: movl    $0, +0xab1000(%rax)      */
  0x48, 0x8b, 0x43, 0x18,                   /*20: mov     +0x18(%rbx), %rax        */
  0x8b, 0x90, 0x08, 0x10, 0xab, 0x00,       /*24: mov     +0xab1008(%rax), %edx    */
  0x48, 0x8b, 0xbb, 0xa0, 0x02, 0x00, 0x00, /*2a: mov     +0x2a0(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*31: mov     $0xab0000, %esi          */
  0x31, 0xc0,                               /*36: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*38: callq   +0x170(%rbx)             */
  0x48, 0x89, 0xdf,                         /*3e: mov     %rbx, %rdi               */
...
/* args: {"a"=>[[16, 8, 42..45], [16, 0, 49..52]]} */
static uint8_t op_loadself[] = {
  0x53,                                     /*00: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0x43, 0x18,                   /*04: mov     +0x18(%rbx), %rax        */
  0x8b, 0x70, 0x18,                         /*08: mov     +0x18(%rax), %esi        */
  0x48, 0x8b, 0xbb, 0x98, 0x02, 0x00, 0x00, /*0b: mov     +0x298(%rbx), %rdi       */
  0x31, 0xc0,                               /*12: xor     %eax, %eax               */
  0x89, 0xf2,                               /*14: mov     %esi, %edx               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*16: callq   +0x170(%rbx)             */
  0x48, 0x8b, 0x43, 0x18,                   /*1c: mov     +0x18(%rbx), %rax        */
  0x48, 0x8b, 0x08,                         /*20: mov     (%rax), %rcx             */
  0x48, 0x8b, 0x50, 0x08,                   /*23: mov     +0x8(%rax), %rdx         */
  0x48, 0x89, 0x90, 0x08, 0x10, 0xab, 0x00, /*27: mov     %rdx, +0xab1008(%rax)    */
  0x48, 0x89, 0x88, 0x00, 0x10, 0xab, 0x00, /*2e: mov     %rcx, +0xab1000(%rax)    */
...
static uint8_t op_loadt[] = {
  0x48, 0x8b, 0x47, 0x18,                   /*00: mov     +0x18(%rdi), %rax        */
  0xc7, 0x80, 0x08, 0x10, 0xab, 0x00, 0x02, 0x00, 0x00, 0x00,/*04: movl    $0x2, +0xab1008(%rax)    */
  0x48, 0x8b, 0x47, 0x18,                   /*0e: mov     +0x18(%rdi), %rax        */
...
static uint8_t op_loadf[] = {
  0x48, 0x8b, 0x47, 0x18,                   /*00: mov     +0x18(%rdi), %rax        */
  0xc7, 0x80, 0x08, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*04: movl    $0, +0xab1008(%rax)      */
  0x48, 0x8b, 0x47, 0x18,                   /*0e: mov     +0x18(%rdi), %rax        */
  0xc7, 0x80, 0x00, 0x10, 0xab, 0x00, 0x01, 0x00, 0x00, 0x00,/*12: movl    $0x1, +0xab1000(%rax)    */
...
static uint8_t op_setspecial[] = {
  ...
  0x48, 0x8b, 0x90, 0x00, 0x10, 0xab, 0x00, /*0c: mov     +0xab1000(%rax), %rdx    */
...
static uint8_t op_getiv[] = {
  ...
  0x48, 0x8b, 0x43, 0x28,                   /*0e: mov     +0x28(%rbx), %rax        */
  0x8b, 0xb0, 0x00, 0x04, 0xbc, 0x00,       /*12: mov     +0xbc0400(%rax), %esi    */
  0xff, 0x93, 0xb0, 0x00, 0x00, 0x00,       /*18: callq   +0xb0(%rbx)              */
  0x49, 0x89, 0x86, 0x00, 0x10, 0xab, 0x00, /*1e: mov     %rax, +0xab1000(%r14)    */
  0x41, 0x89, 0x96, 0x08, 0x10, 0xab, 0x00, /*25: mov     %edx, +0xab1008(%r14)    */
  0x48, 0x89, 0xdf,                         /*2c: mov     %rbx, %rdi               */
  0x5b,                                     /*2f: pop     %rbx                     */
...
static uint8_t op_getupvar[] = {
  ...
  0xeb, 0x14,                               /*3e: jmp                              */
  0xff, 0x93, 0xb8, 0x00, 0x00, 0x00,       /*40: callq   +0xb8(%rbx)              */
...
static uint8_t op_rescue[] = {
  ...
  0x89, 0x88, 0x08, 0x10, 0xab, 0x00,       /*0f: mov     %ecx, +0xab1008(%rax)    */
...
static uint8_t op_raise[] = {
  ...
  0x48, 0x8b, 0x43, 0x18,                   /*04: mov     +0x18(%rbx), %rax        */
  0x48, 0x8b, 0x4b, 0x58,                   /*08: mov     +0x58(%rbx), %rcx        */
  0x48, 0x8b, 0x80, 0x00, 0x10, 0xab, 0x00, /*0c: mov     +0xab1000(%rax), %rax    */
...
/* args: {"a"=>[[1, 0, 22..25], [1, 0, 45..48], [1, 0, 79..82]], "b"=>[[1, 0, 27..30], [1, 0, 50..53], [1, 0, 84..87]], "c"=>[[1, 0, 32..35], [1, 0, 56..59], [1, 0, 89..92]]} */
static uint8_t op_send[] = {
  0x55,                                     /*00: push    %rbp                     */
  0x53,                                     /*01: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*02: mov     %rdi, %rbx               */
  0x48, 0x8b, 0x43, 0x10,                   /*05: mov     +0x10(%rbx), %rax        */
  0x8b, 0x28,                               /*09: mov     (%rax), %ebp             */
  0x83, 0xe5, 0x7f,                         /*0b: and     $0x7f, %ebp              */
  0x48, 0x8b, 0xbb, 0xa8, 0x02, 0x00, 0x00, /*0e: mov     +0x2a8(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*15: mov     $0xab0000, %esi          */
  0xba, 0x00, 0x00, 0xbc, 0x00,             /*1a: mov     $0xbc0000, %edx          */
  0xb9, 0x00, 0x00, 0xcd, 0x00,             /*1f: mov     $0xcd0000, %ecx          */
  0x31, 0xc0,                               /*24: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*26: callq   +0x170(%rbx)             */
  0xba, 0x00, 0x00, 0xab, 0x00,             /*2c: mov     $0xab0000, %edx          */
  0xb9, 0x00, 0x00, 0xbc, 0x00,             /*31: mov     $0xbc0000, %ecx          */
  0x41, 0xb8, 0x00, 0x00, 0xcd, 0x00,       /*36: mov     $0xcd0000, %r8d          */
  0x48, 0x89, 0xdf,                         /*3c: mov     %rbx, %rdi               */
  0x89, 0xee,                               /*3f: mov     %ebp, %esi               */
  0xff, 0x93, 0xe0, 0x01, 0x00, 0x00,       /*41: callq   +0x1e0(%rbx)             */
  0x48, 0x8b, 0xbb, 0xa8, 0x02, 0x00, 0x00, /*47: mov     +0x2a8(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*4e: mov     $0xab0000, %esi          */
  0xba, 0x00, 0x00, 0xbc, 0x00,             /*53: mov     $0xbc0000, %edx          */
  0xb9, 0x00, 0x00, 0xcd, 0x00,             /*58: mov     $0xcd0000, %ecx          */
  0x31, 0xc0,                               /*5d: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*5f: callq   +0x170(%rbx)             */
...
static uint8_t op_call[] = {
  ...
  0x41, 0xff, 0x96, 0xb8, 0x00, 0x00, 0x00, /*14b: callq   +0xb8(%r14)              */
  ...
  0x41, 0xff, 0x96, 0x30, 0x01, 0x00, 0x00, /*17b: callq   +0x130(%r14)             */
...
static uint8_t op_super[] = {
  ...
  0x48, 0x8b, 0xb3, 0xb0, 0x02, 0x00, 0x00, /*66: mov     +0x2b0(%rbx), %rsi       */
  ...
  0xff, 0x93, 0x30, 0x01, 0x00, 0x00,       /*1be: callq   +0x130(%rbx)             */
...
static uint8_t op_enter[] = {
  ...
  0x4d, 0x8b, 0x84, 0x24, 0xc0, 0x02, 0x00, 0x00,/*af: mov     +0x2c0(%r12), %r8        */
  0x4d, 0x8b, 0x8c, 0x24, 0xc8, 0x02, 0x00, 0x00,/*b7: mov     +0x2c8(%r12), %r9        */
  ...
  0x49, 0x8b, 0xbc, 0x24, 0xd0, 0x02, 0x00, 0x00,/*42f: mov     +0x2d0(%r12), %rdi       */
...
/* args: {"a"=>[[1, 0, 12..15], [1, 0, 30..33], [1, 0, 56..59]], "b"=>[[1, 0, 17..20], [1, 0, 35..38], [1, 0, 61..64]]} */
static uint8_t op_return[] = {
  ...
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*17: callq   +0x170(%rbx)             */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*1d: mov     $0xab0000, %esi          */
  0xba, 0x00, 0x00, 0xbc, 0x00,             /*22: mov     $0xbc0000, %edx          */
  0x48, 0x89, 0xdf,                         /*27: mov     %rbx, %rdi               */
  0xff, 0x93, 0x80, 0x00, 0x00, 0x00,       /*2a: callq   +0x80(%rbx)              */
  0x48, 0x8b, 0xbb, 0xd8, 0x02, 0x00, 0x00, /*30: mov     +0x2d8(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*37: mov     $0xab0000, %esi          */
  0xba, 0x00, 0x00, 0xbc, 0x00,             /*3c: mov     $0xbc0000, %edx          */
  0x31, 0xc0,                               /*41: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*43: callq   +0x170(%rbx)             */
  0x48, 0x89, 0xdf,                         /*49: mov     %rbx, %rdi               */
  0x5b,                                     /*4c: pop     %rbx                     */
  0xc3,                                     /*4d: ret                              */
...
static uint8_t op_tailcall[] = {
  ...
  0x48, 0x8b, 0xb3, 0xb0, 0x02, 0x00, 0x00, /*77: mov     +0x2b0(%rbx), %rsi       */
  ...
  0xff, 0x93, 0x30, 0x01, 0x00, 0x00,       /*18b: callq   +0x130(%rbx)             */
...
static uint8_t op_blkpush[] = {
  ...
  0x48, 0x8b, 0x50, 0x18,                   /*08: mov     +0x18(%rax), %rdx        */
  0x48, 0x89, 0x90, 0x08, 0x10, 0xab, 0x00, /*0c: mov     %rdx, +0xab1008(%rax)    */
...
/* args: {"a"=>[[16, 0, 18..21], [16, 0, 24..27], [16, 8, 30..33], [1, 0, 42..45], [16, 0, 67..70], [16, 8, 73..76], [16, 8, 94..97], [16, 8, 159..162], [16, 0, 184..187], [16, 24, 192..195], [16, 16, 202..205], [1, 0, 216..219], [16, 8, 244..247], [16, 0, 258..261]], "c"=>[[1, 0, 140..143], [1, 0, 206..209]], "b"=>[[1, 0, 221..224]]} */
static uint8_t op_addi[] = {
  ...
  0x4c, 0x8d, 0xb5, 0x00, 0x10, 0xab, 0x00, /*0f: lea     +0xab1000(%rbp), %r14    */
  0x8b, 0x8d, 0x00, 0x10, 0xab, 0x00,       /*16: mov     +0xab1000(%rbp), %ecx    */
  0x8b, 0x95, 0x08, 0x10, 0xab, 0x00,       /*1c: mov     +0xab1008(%rbp), %edx    */
  0x48, 0x8b, 0xbb, 0xe0, 0x02, 0x00, 0x00, /*22: mov     +0x2e0(%rbx), %rdi       */
  ...
  0x8b, 0x8d, 0x00, 0x10, 0xab, 0x00,       /*41: mov     +0xab1000(%rbp), %ecx    */
  0x8b, 0x95, 0x08, 0x10, 0xab, 0x00,       /*47: mov     +0xab1008(%rbp), %edx    */
  0x48, 0x8b, 0xbb, 0xe0, 0x02, 0x00, 0x00, /*4d: mov     +0x2e0(%rbx), %rdi       */
  0x31, 0xc0,                               /*54: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*56: callq   +0x170(%rbx)             */
  0x8b, 0x85, 0x08, 0x10, 0xab, 0x00,       /*5c: mov     +0xab1008(%rbp), %eax    */
  ...
  0x74, 0x55,                               /*9b: je                               */
  0xc7, 0x85, 0x08, 0x10, 0xab, 0x00, 0x06, 0x00, 0x00, 0x00,/*9d: movl    $0x6, +0xab1008(%rbp)    */
  ...
  0xf2, 0x0f, 0x11, 0x85, 0x00, 0x10, 0xab, 0x00,/*b4: movsd   %xmm0, +0xab1000(%rbp)   */
  0xeb, 0x48,                               /*bc: jmp                              */
  0xc7, 0x85, 0x18, 0x10, 0xab, 0x00, 0x03, 0x00, 0x00, 0x00,/*be: movl    $0x3, +0xab1018(%rbp)    */
  0xc7, 0x85, 0x10, 0x10, 0xab, 0x00, 0x00, 0x00, 0xcd, 0x00,/*c8: movl    $0xcd0000, +0xab1010(%rbp) */
  ...
  0xeb, 0x14,                               /*f0: jmp                              */
  0xc7, 0x85, 0x08, 0x10, 0xab, 0x00, 0x03, 0x00, 0x00, 0x00,/*f2: movl    $0x3, +0xab1008(%rbp)    */
  0x8b, 0x44, 0x24, 0x0c,                   /*fc: mov     +0xc(%rsp), %eax         */
  0x89, 0x85, 0x00, 0x10, 0xab, 0x00,       /*100: mov     %eax, +0xab1000(%rbp)    */
...
static void op_addi_set_args(uint8_t *op, uint32_t a, int32_t b, uint8_t c) {
  ...
  *((int32_t *)(op + 42)) = a * 1 + 0;
  *((int32_t *)(op + 67)) = a * 16 + 0;
  *((int32_t *)(op + 73)) = a * 16 + 8;
  *((int32_t *)(op + 94)) = a * 16 + 8;
  *((int32_t *)(op + 159)) = a * 16 + 8;
  *((int32_t *)(op + 184)) = a * 16 + 0;
  *((int32_t *)(op + 192)) = a * 16 + 24;
  *((int32_t *)(op + 202)) = a * 16 + 16;
  *((int32_t *)(op + 216)) = a * 1 + 0;
  *((int32_t *)(op + 244)) = a * 16 + 8;
  *((int32_t *)(op + 258)) = a * 16 + 0;
...
static uint8_t op_sub[] = {
  ...
  0x8b, 0x8d, 0x08, 0x10, 0xab, 0x00,       /*0d: mov     +0xab1008(%rbp), %ecx    */
...
static uint8_t op_subi[] = {
  ...
  0x48, 0x89, 0xfb,                         /*08: mov     %rdi, %rbx               */
  0x48, 0x8b, 0x6b, 0x18,                   /*0b: mov     +0x18(%rbx), %rbp        */
  0x8b, 0x85, 0x08, 0x10, 0xab, 0x00,       /*0f: mov     +0xab1008(%rbp), %eax    */
...
static uint8_t op_mul[] = {
  ...
  0x8b, 0x93, 0x08, 0x10, 0xab, 0x00,       /*0a: mov     +0xab1008(%rbx), %edx    */
...
static uint8_t op_div[] = {
  ...
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0x43, 0x18,                   /*04: mov     +0x18(%rbx), %rax        */
  0x8b, 0x90, 0x08, 0x10, 0xab, 0x00,       /*08: mov     +0xab1008(%rax), %edx    */
...
/* args: {"a"=>[[16, 0, 17..20], [16, 8, 23..26], [16, 16, 30..33], [16, 24, 37..40], [16, 8, 58..61], [16, 24, 74..77], [16, 0, 96..99], [16, 16, 102..105], [16, 16, 125..128], [16, 0, 133..136], [16, 0, 151..154], [16, 0, 168..171], [16, 16, 176..179], [16, 8, 195..198], [16, 8, 207..210], [16, 0, 217..220]]} */
static uint8_t op_eq[] = {
  ...
  0x48, 0x8b, 0xb3, 0x00, 0x10, 0xab, 0x00, /*0e: mov     +0xab1000(%rbx), %rsi    */
  ...
  0x0f, 0x85, 0xb5, 0x00, 0x00, 0x00,       /*32: jne                              */
  ...
  0xeb, 0x0a,                               /*cb: jmp                              */
  0xc7, 0x83, 0x08, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*cd: movl    $0, +0xab1008(%rbx)      */
  0xc7, 0x83, 0x00, 0x10, 0xab, 0x00, 0x01, 0x00, 0x00, 0x00,/*d7: movl    $0x1, +0xab1000(%rbx)    */
  0xeb, 0x0a,                               /*e1: jmp                              */
  0x4c, 0x89, 0xf7,                         /*e3: mov     %r14, %rdi               */
  0x41, 0xff, 0x96, 0x48, 0x02, 0x00, 0x00, /*e6: callq   +0x248(%r14)             */
  0x4c, 0x89, 0xf7,                         /*ed: mov     %r14, %rdi               */
  0x5b,                                     /*f0: pop     %rbx                     */
  0x41, 0x5e,                               /*f1: pop     %r14                     */
...
static uint8_t op_lt[] = {
  ...
  0xeb, 0x0a,                               /*a0: jmp                              */
  0xc7, 0x80, 0x08, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*a2: movl    $0, +0xab1008(%rax)      */
...
static uint8_t op_array[] = {
  ...
  0x4c, 0x8b, 0x73, 0x18,                   /*06: mov     +0x18(%rbx), %r14        */
  0x48, 0x8b, 0x7b, 0x58,                   /*0a: mov     +0x58(%rbx), %rdi        */
  0x49, 0x8d, 0x96, 0x00, 0x10, 0xbc, 0x00, /*0e: lea     +0xbc1000(%r14), %rdx    */
...
static uint8_t op_arypush[] = {
  ...
  0x48, 0x8b, 0x43, 0x18,                   /*04: mov     +0x18(%rbx), %rax        */
  0x48, 0x8b, 0x7b, 0x58,                   /*08: mov     +0x58(%rbx), %rdi        */
  0x48, 0x8b, 0xb0, 0x00, 0x10, 0xab, 0x00, /*0c: mov     +0xab1000(%rax), %rsi    */
...
static uint8_t op_aref[] = {
  ...
  0x49, 0x89, 0xfe,                         /*03: mov     %rdi, %r14               */
  0x49, 0x8b, 0x5e, 0x18,                   /*06: mov     +0x18(%r14), %rbx        */
  0x83, 0xbb, 0x08, 0x10, 0xbc, 0x00, 0x0e, /*0a: cmpl    $0xe, +0xbc1008(%rbx)    */
  0x75, 0x2b,                               /*11: jne                              */
  ...
  0xeb, 0x18,                               /*3c: jmp                              */
  0xc7, 0x83, 0x08, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*3e: movl    $0, +0xab1008(%rbx)      */
  0x49, 0x8b, 0x46, 0x18,                   /*48: mov     +0x18(%r14), %rax        */
  0xc7, 0x80, 0x00, 0x10, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00,/*4c: movl    $0, +0xab1000(%rax)      */
...
static uint8_t op_aset[] = {
  ...
  0x48, 0x8b, 0x43, 0x18,                   /*04: mov     +0x18(%rbx), %rax        */
  0x48, 0x8b, 0x7b, 0x58,                   /*08: mov     +0x58(%rbx), %rdi        */
  0x48, 0x8b, 0xb0, 0x00, 0x10, 0xbc, 0x00, /*0c: mov     +0xbc1000(%rax), %rsi    */
...
static uint8_t op_apost[] = {
  ...
  0x41, 0x83, 0xbc, 0x24, 0x08, 0x10, 0xab, 0x00, 0x0e,/*0f: cmpl    $0xe, +0xab1008(%r12)    */
...
static uint8_t op_string[] = {
  ...
  0x48, 0x8b, 0xbb, 0xe8, 0x02, 0x00, 0x00, /*33: mov     +0x2e8(%rbx), %rdi       */
  0x31, 0xc0,                               /*3a: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*3c: callq   +0x170(%rbx)             */
  0x8b, 0x43, 0x50,                         /*42: mov     +0x50(%rbx), %eax        */
  0x48, 0x8b, 0x4b, 0x58,                   /*45: mov     +0x58(%rbx), %rcx        */
  0x89, 0x81, 0xdc, 0x00, 0x00, 0x00,       /*49: mov     %eax, +0xdc(%rcx)        */
  0x48, 0x89, 0xdf,                         /*4f: mov     %rbx, %rdi               */
...
static uint8_t op_lambda[] = {
  ...
  0x75, 0x49,                               /*41: jne                              */
  0xeb, 0x4c,                               /*43: jmp                              */
  0xff, 0x93, 0x38, 0x01, 0x00, 0x00,       /*45: callq   +0x138(%rbx)             */
  ...
  0x48, 0x8b, 0xb3, 0xf0, 0x02, 0x00, 0x00, /*65: mov     +0x2f0(%rbx), %rsi       */
...
static uint8_t op_range[] = {
  ...
  0x49, 0x8b, 0x5e, 0x18,                   /*06: mov     +0x18(%r14), %rbx        */
  0x49, 0x8b, 0x7e, 0x58,                   /*0a: mov     +0x58(%r14), %rdi        */
  0x48, 0x8b, 0xb3, 0x00, 0x10, 0xbc, 0x00, /*0e: mov     +0xbc1000(%rbx), %rsi    */
...
static uint8_t op_module[] = {
  ...
  0x8b, 0xa8, 0x00, 0x04, 0xbc, 0x00,       /*0d: mov     +0xbc0400(%rax), %ebp    */
...
static uint8_t op_exec[] = {
  ...
  0xff, 0x93, 0x38, 0x01, 0x00, 0x00,       /*84: callq   +0x138(%rbx)             */
  ...
  0xff, 0x93, 0x30, 0x01, 0x00, 0x00,       /*108: callq   +0x130(%rbx)             */
...
static uint8_t op_sclass[] = {
  ...
  0x4c, 0x8b, 0x73, 0x18,                   /*06: mov     +0x18(%rbx), %r14        */
  0x48, 0x8b, 0x7b, 0x58,                   /*0a: mov     +0x58(%rbx), %rdi        */
  0x49, 0x8b, 0xb6, 0x00, 0x10, 0xbc, 0x00, /*0e: mov     +0xbc1000(%r14), %rsi    */
...
static uint8_t op_debug[] = {
  0x53,                                     /*00: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0xbb, 0x00, 0x03, 0x00, 0x00, /*04: mov     +0x300(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*0b: mov     $0xab0000, %esi          */
  0xba, 0x00, 0x00, 0xbc, 0x00,             /*10: mov     $0xbc0000, %edx          */
...
static uint8_t op_stop[] = {
  0x53,                                     /*00: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0xbb, 0x08, 0x03, 0x00, 0x00, /*04: mov     +0x308(%rbx), %rdi       */
  0x31, 0xc0,                               /*0b: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*0d: callq   +0x170(%rbx)             */
  0x48, 0x89, 0xdf,                         /*13: mov     %rbx, %rdi               */
  0xff, 0x93, 0xd0, 0x01, 0x00, 0x00,       /*16: callq   +0x1d0(%rbx)             */
...
static size_t op_sizes[] = {
  ...
  sizeof(op_loadnil), /* 66 */
  sizeof(op_loadself), /* 57 */
  sizeof(op_loadt), /* 28 */
  sizeof(op_loadf), /* 28 */
