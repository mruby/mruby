...
static uint8_t op_loadnil[] = {
  ...
  0x48, 0x8b, 0x43, 0x18,                   /*20: mov     +0x18(%rbx), %rax        */
  0x8b, 0x90, 0x08, 0x10, 0xab, 0x00,       /*24: mov     +0xab1008(%rax), %edx    */
  0x48, 0x8b, 0xbb, 0x98, 0x02, 0x00, 0x00, /*2a: mov     +0x298(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*31: mov     $0xab0000, %esi          */
  0x31, 0xc0,                               /*36: xor     %eax, %eax               */
  0xff, 0x93, 0x70, 0x01, 0x00, 0x00,       /*38: callq   +0x170(%rbx)             */
  0x48, 0x89, 0xdf,                         /*3e: mov     %rbx, %rdi               */
...
static uint8_t op_loadself[] = {
  ...
  0x48, 0x89, 0x90, 0x08, 0x10, 0xab, 0x00, /*0b: mov     %rdx, +0xab1008(%rax)    */
...
static uint8_t op_send[] = {
  ...
  0x48, 0x8b, 0xbb, 0xa0, 0x02, 0x00, 0x00, /*0e: mov     +0x2a0(%rbx), %rdi       */
  ...
  0x48, 0x8b, 0xbb, 0xa0, 0x02, 0x00, 0x00, /*47: mov     +0x2a0(%rbx), %rdi       */
...
static uint8_t op_enter[] = {
  ...
  0x4d, 0x8b, 0x84, 0x24, 0xb8, 0x02, 0x00, 0x00,/*af: mov     +0x2b8(%r12), %r8        */
  0x4d, 0x8b, 0x8c, 0x24, 0xc0, 0x02, 0x00, 0x00,/*b7: mov     +0x2c0(%r12), %r9        */
  ...
  0x49, 0x8b, 0xbc, 0x24, 0xc8, 0x02, 0x00, 0x00,/*42f: mov     +0x2c8(%r12), %rdi       */
...
static uint8_t op_return[] = {
  0x53,                                     /*00: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0xbb, 0xd0, 0x02, 0x00, 0x00, /*04: mov     +0x2d0(%rbx), %rdi       */
  ...
  0x48, 0x8b, 0xbb, 0xd0, 0x02, 0x00, 0x00, /*30: mov     +0x2d0(%rbx), %rdi       */
...
static uint8_t op_addi[] = {
  ...
  0x48, 0x8b, 0xbb, 0xd8, 0x02, 0x00, 0x00, /*22: mov     +0x2d8(%rbx), %rdi       */
  ...
  0x48, 0x8b, 0xbb, 0xd8, 0x02, 0x00, 0x00, /*4d: mov     +0x2d8(%rbx), %rdi       */
...
static uint8_t op_lambda[] = {
  ...
  0x48, 0x8b, 0xb3, 0xe0, 0x02, 0x00, 0x00, /*65: mov     +0x2e0(%rbx), %rsi       */
...
static uint8_t op_tclass[] = {
  ...
  0x48, 0x8b, 0xb3, 0xe8, 0x02, 0x00, 0x00, /*4d: mov     +0x2e8(%rbx), %rsi       */
...
static uint8_t op_debug[] = {
  0x53,                                     /*00: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0xbb, 0xf0, 0x02, 0x00, 0x00, /*04: mov     +0x2f0(%rbx), %rdi       */
  0xbe, 0x00, 0x00, 0xab, 0x00,             /*0b: mov     $0xab0000, %esi          */
  0xba, 0x00, 0x00, 0xbc, 0x00,             /*10: mov     $0xbc0000, %edx          */
...
static uint8_t op_stop[] = {
  0x53,                                     /*00: push    %rbx                     */
  0x48, 0x89, 0xfb,                         /*01: mov     %rdi, %rbx               */
  0x48, 0x8b, 0xbb, 0xf8, 0x02, 0x00, 0x00, /*04: mov     +0x2f8(%rbx), %rdi       */
