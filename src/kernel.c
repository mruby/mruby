...
static const mrb_mt_entry kernel_rom_entries[] = {
  MRB_MT_ENTRY(mrb_eqq_m,                        MRB_OPSYM(eqq),                      0),
  MRB_MT_ENTRY(mrb_cmp_m,                        MRB_OPSYM(cmp),                       0),
  MRB_MT_ENTRY(mrb_f_block_given_p_m,            MRB_SYM_Q(block_given),               MRB_MT_NOARG|MRB_MT_PRIVATE),
  MRB_MT_ENTRY(mrb_obj_class_m,                  MRB_SYM(class),                        MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_clone,                    MRB_SYM(clone),                        MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_dup,                      MRB_SYM(dup),                          MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_equal_m,                  MRB_SYM_Q(eql),                        0),
  MRB_MT_ENTRY(mrb_obj_freeze,                   MRB_SYM(freeze),                       MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_frozen,                   MRB_SYM_Q(frozen),                     MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_extend,                   MRB_SYM(extend),                       0),
  MRB_MT_ENTRY(mrb_obj_hash,                     MRB_SYM(hash),                         MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_init_copy,                MRB_SYM(initialize_copy),              MRB_MT_PRIVATE),
  MRB_MT_ENTRY(mrb_obj_inspect,                  MRB_SYM(inspect),                      MRB_MT_NOARG),
  MRB_MT_ENTRY(obj_is_instance_of,               MRB_SYM_Q(instance_of),                0),
  MRB_MT_ENTRY(mrb_obj_is_kind_of_m,             MRB_SYM_Q(is_a),                       0),
  MRB_MT_ENTRY(mrb_f_block_given_p_m,            MRB_SYM_Q(iterator),                   MRB_MT_NOARG|MRB_MT_PRIVATE),
  MRB_MT_ENTRY(mrb_obj_is_kind_of_m,             MRB_SYM_Q(kind_of),                    0),
  MRB_MT_ENTRY(mrb_false,                        MRB_SYM_Q(nil),                        MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_id_m,                     MRB_SYM(object_id),                    MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_f_raise,                      MRB_SYM(raise),                        MRB_MT_PRIVATE),
  MRB_MT_ENTRY(mrb_obj_remove_instance_variable, MRB_SYM(remove_instance_variable),     0),
  MRB_MT_ENTRY(obj_respond_to,                   MRB_SYM_Q(respond_to),                 0),
  MRB_MT_ENTRY(mrb_any_to_s,                     MRB_SYM(to_s),                         MRB_MT_NOARG),
  MRB_MT_ENTRY(mrb_obj_ceqq,                     MRB_SYM(__case_eqq),                   0),
